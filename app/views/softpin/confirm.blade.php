    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" id="form">
        	{{Form::open(array('url'=>'bankings', 'method'=>'post', 'class'=>'form-horizontal'))}}
	            ...
	            <div class="form-group">
	              {{Form::label('lthe', 'Loại thẻ mua', array('class'=>'col-sm-2 control-label'))}}
	              <div class="col-sm-10"><p class="form-control-static">{{{$lthe}}}</p></div>
	            </div>

	            <div class="form-group">
	              {{Form::label('sluong', 'Số lượng thẻ mua', array('class'=>'col-sm-2 control-label'))}}
	              <div class="col-sm-10"><p class="form-control-static">{{{$sluong}}}</p></div>
	            </div>
