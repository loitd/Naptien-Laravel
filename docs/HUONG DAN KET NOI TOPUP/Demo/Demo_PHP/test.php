<?php
	...
	//14. Kiem tra hang trong kho
	partnerCheckProductDetail($itopupClient);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	// DIRECT TOPUP
	...
	function partnerCheckProductDetail($itopupClient){
	echo "__________________________________________________<br>";
		echo "<br><b>partnerCheckProductDetail. Cac tham so dau vao: </b><br>";
		$productID = 1;
		$quantity = 100;		//Bat buoc phai sinh ra	
		echo "productID: ".$productID."<br>quantity: ".$quantity."<br>";
		$itopupClient->partnerCheckProductDetail($productID, $quantity);
	}
?>